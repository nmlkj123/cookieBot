...
async def on_message(message):
    if message.content.startswith('!서정'):
        ...
        lolm=['2019.07.18 [RIP]','(정보)그녀는 이세계 사람 입니다.','★뭐든지 잘하는 그녀는 대체;'
              ,'그녀는 군필여고생 후보 입니다. 당신도 똑같다구요? 어쩌라고요','너도울고 나도 울었따','분명 챌린저 였으나, 상대하는것은 마치 다이아와 같았으니 우리팀 피지컬에 혀를 내두르며 채팅을 치더라. \n
